...
class StoreOfficeSpaceListingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return array_merge(
            ...
            [
                ...
                'office_lease_terms_extn.tax_on_cusa' => ['required', new Enum(TaxOnCusa::class)],
                ...
                'office_turnover_conditions.handover' => ['required', new Enum(HandoverType::class)], // enum later
                ...
                'office_specs.accreditation' => ['required', new Enum(AccreditationType::class)],
                'office_specs.certification' => 'nullable|string',

                // 🧑‍💼 office_other_details_extn table
                'office_other_detail_extn.a/c_unit' => ['required', new Enum(AcUnitType::class)],
                ...
                'office_other_detail_extn.backup_power' => ['required', new Enum(BackupPowerType::class)],
                'office_other_detail_extn.fiber_optic_capability' => ['required', new Enum(FiberOpticCapability::class)],
                ...
                'office_other_detail_extn.private_toilet' => ['required', new Enum(ToiletType::class)],
                'office_other_detail_extn.common_toilet' => ['required', new Enum(ToiletType::class)],
