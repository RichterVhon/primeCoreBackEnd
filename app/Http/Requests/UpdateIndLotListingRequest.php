...
class UpdateIndLotListingRequest extends FormRequest
{
...
{
    return array_merge(
        $this->listingRulesForUpdate(), // Assuming this includes base rules for ind_lot_listings
        [
            ...
            'ind_lot_listing_property_details.lot_shape' => ['sometimes', new Enum(LotShape::class)],
            'ind_lot_listing_property_details.frontage_width' => 'nullable|numeric',
            'ind_lot_listing_property_details.depth' => 'nullable|numeric',
            'ind_lot_listing_property_details.zoning_classification' =>  ['sometimes', new Enum(ZoningClassification::class)],
            'ind_lot_listing_property_details.offering' =>  ['sometimes', new Enum(Offering::class)], // Replace with Enum later if needed

            // 🧱 ind_lot_turnover_conditions table 
            'ind_lot_turnover_conditions.lot_condition' =>  ['sometimes', new Enum(LotCondition::class)], // Replace with Enum later if needed
